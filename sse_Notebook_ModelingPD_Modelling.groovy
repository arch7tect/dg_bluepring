...
entity.notebookType = null
entity.paragraphs.find {it.name == "ModelingPD_BAI_Modelling_2019-03-11T11:44:24.149"}.body.linkNotebook = session.createQuery("from sse.LibraryNotebook where name = :name").setParameter("name", "FunctionLibrary").uniqueResult()
